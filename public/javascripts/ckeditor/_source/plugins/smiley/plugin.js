...
CKEDITOR.config.smiley_images = [
	'1_smile.gif','biggrin.gif', 'no.gif', 'blush.gif', 'confused.gif', 'crying.gif',
        'lol.gif', 'rolleyes.gif', 'sleeping.gif', 'tongue.gif', 'w00t.gif',
        'wub.gif', 'thumbup.gif', 'thumbdown.gif', 'whistling.gif', 'eek.gif',
        'unsure.gif', 'scared.gif', 'kiss.gif', 'excl.gif', 'cursing.gif',
        'devil.gif', 'cool.gif', 'angry.gif', 'blink.gif', 'clover.gif' ];
...
CKEDITOR.config.smiley_descriptions =
	[
		'smile','bigsmile', 'no', 'blush', 'confused', 'crying',
        'lol', 'rolleyes', 'sleeping', 'tongue', 'w00t',
        'wub', 'thumbup', 'thumbdown', 'whistling', 'eek',
        'unsure', 'scared', 'kiss', 'excl', 'cursing',
        'devil', 'cool', 'angry', 'blink', 'clover' ];
